...
public class ManipularDoc {
	...
	public static void main(String[] args) throws Exception {
		...
		styleRun(titulo, "Star Wars", "Arial", "0000FF", 18);
		...
		ref.setText("Inserido por Junior Souza. Disponível em: <https://pt.wikipedia.org/wiki/Star_Wars>. Acessado em 15 de novembro de 2018 às 13h16min. ");
